...
IF %ERRORLEVEL% EQU 0 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 3010 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 1641 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 13 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 87 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 259 ERASE /F /Q FAILURE.FLG 
IF %ERRORLEVEL% EQU 1601 ERASE /F /Q FAILURE.FLG 
EXIT / B %ERRORLEVEL%
